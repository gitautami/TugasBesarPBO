namespace tbpbo2
{
    partial class InputData
    {
        ...
        private void InitializeComponent()
        {
            ...
            label6 = new Label();
            label7 = new Label();
            dateTimePickerTTL = new DateTimePicker();
            comboBoxJenis = new ComboBox();
            textBoxNomorTLP = new TextBox();
            textBoxAlamat = new TextBox();
            comboBoxGolongan = new ComboBox();
            label8 = new Label();
            label9 = new Label();
            textBoxRiwayat = new TextBox();
            label10 = new Label();
            textBoxAlergi = new TextBox();
            label11 = new Label();
            textBoxNomorDarurat = new TextBox();
            label12 = new Label();
            label13 = new Label();
            textBoxNamaDarurat = new TextBox();
            label14 = new Label();
            ...
            buttonLaporan.Location = new Point(0, 401);
            ...
            buttonJadwal.Location = new Point(0, 251);
            ...
            buttonInput.Location = new Point(0, 111);
            ...
            Controls.Add(textBoxNomorDarurat);
            Controls.Add(label12);
            Controls.Add(label13);
            Controls.Add(textBoxNamaDarurat);
            Controls.Add(label14);
            Controls.Add(textBoxAlergi);
            Controls.Add(label11);
            Controls.Add(label9);
            Controls.Add(textBoxRiwayat);
            Controls.Add(label10);
            Controls.Add(label8);
            Controls.Add(comboBoxGolongan);
            Controls.Add(textBoxAlamat);
            Controls.Add(textBoxNomorTLP);
            Controls.Add(comboBoxJenis);
            Controls.Add(dateTimePickerTTL);
            Controls.Add(label6);
            Controls.Add(label7);
            Controls.Add(label2);
            Controls.Add(label5);
        ...
        private DateTimePicker dateTimePickerTTL;
        private ComboBox comboBoxJenis;
        private TextBox textBoxNomorTLP;
        private TextBox textBoxAlamat;
        private ComboBox comboBoxGolongan;
        private Label label8;
        private Label label9;
        private TextBox textBoxRiwayat;
        private Label label10;
        private TextBox textBoxAlergi;
        private Label label11;
        private TextBox textBoxNomorDarurat;
        private Label label12;
        private Label label13;
        private TextBox textBoxNamaDarurat;
